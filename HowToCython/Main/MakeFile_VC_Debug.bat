...
REM SET VSINSTALLDIR=C:\Program Files (x86)\Microsoft Visual Studio\2019\Community
REM SET VCINSTALLDIR=C:\Program Files (x86)\Microsoft Visual Studio\2019\Community\VC
